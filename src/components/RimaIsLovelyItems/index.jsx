...
const rimaIsLovelyItems = [
  {
    ...
    alt: 'Creative',
    description:
      'RIMAは他にはない独特な感性の持ち主。ラップを作詞するだけではなく、キャラクターを描いたり、独自の言語を作ったりとクリエイティブ。NiziUメンバーやWithUに発信して浸透させる力があるのも彼女のすごいところ。',
  },
  {
    heading: rimaIsLovelyDiligent,
    alt: 'Diligent',
    description:
      '「ラップ」「美貌」だけではないのがRIMA。プライベートでは勉強にとても熱心。それはNIziUメンバーが評するほど。NiziUの活動や練習がある中、勉強に時間を割いているストイックな一面があります。',
  },
  {
    heading: rimaIsLovelyFriendly,
    alt: 'Friendly',
    description:
      '美貌の裏は甘えん坊なRIMA。人懐っこく、周りを笑顔にしてくれる性格です。怖がりで涙もろいところもあり、そんな意外性も人を惹き寄せています。美と愛嬌の絶妙なギャップさがRIMAの一つの魅力。',
  },
];
